...
import com.recall.mybatis.dao.LockMapperAnnoation;
import com.recall.mybatis.entites.Lock;

public class TestOne2On2Annoation {
	...
	public void One2One() throws IOException {
		LockMapperAnnoation lockMapper = sqlSession.getMapper(LockMapperAnnoation.class);
